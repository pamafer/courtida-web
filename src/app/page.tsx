      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="p-8 rounded-2xl border border-white/5 bg-white/[0.02]">
          <form className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-emerald-500/20 mt-2"
            >
          ...
          <div className="mt-6 pt-6 border-t border-white/5 text-center">
            ...
            <a
              href="https://wa.me/5547999999999?text=Olá! Tenho interesse no Courtida para meu clube."
              target="_blank"
