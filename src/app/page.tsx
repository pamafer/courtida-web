...
function Header() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-[#0A1410]/80 border-b border-white/5">
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0A1410]">
      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center pt-24 pb-20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#contato" className="w-full sm:w-auto px-8 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:shadow-emerald-500/20 text-center">
            Quero para meu clube
          </a>
          <a href="#como-funciona" className="w-full sm:w-auto px-8 py-3.5 border border-white/10 hover:border-emerald-500/30 text-gray-300 hover:text-white font-medium rounded-xl transition-all text-center">
            Como funciona
          </a>
        </div>
...
const features = [
  {
    ...
    description: "Câmeras Full HD com reconhecimento facial gravam automaticamente cada partida. Sem operador, sem complicação. O sistema identifica jogadores e organiza os vídeos por pessoa e por jogo.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Transmita jogos ao vivo direto no YouTube com um clique. Familiares, torcedores e patrocinadores assistem de qualquer lugar. Aumente a visibilidade do seu clube sem esforço.",
  },
  {
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    description: "Controle de acesso inteligente com IDFace da Control iD. Identifica jogadores na entrada, registra presença automaticamente e libera o acesso à quadra sem catracas manuais.",
  },
];
    ...
    <section id="funcionalidades" className="py-24 bg-[#060E0A]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Tudo que seu clube precisa</h2>
          <p className="text-gray-400 text-lg max-w-xl mx-auto">Três pilares integrados em uma plataforma única</p>
        </div>
...
const steps = [
  { number: "01", title: "Instalação", description: "Instalamos as câmeras e o terminal de reconhecimento facial na sua quadra em menos de um dia." },
  { number: "02", title: "Cadastro", description: "Jogadores fazem um cadastro rápido com foto. A partir daí, o sistema os reconhece automaticamente." },
  { number: "03", title: "Automação total", description: "Gravação, streaming e controle de acesso funcionam sozinhos. Sem operador, sem intervenção manual. Você foca na gestão do clube." },
  { number: "04", title: "Resultados", description: "Jogadores acessam seus vídeos, famílias assistem ao vivo, e você tem dados reais do uso da quadra." },
];
    ...
    <section id="como-funciona" className="py-24 bg-[#0A1410]">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-xl mx-auto">Do zero ao funcionamento em menos de uma semana</p>
        </div>
          ...
          {steps.map((step, i) => (
            <div key={step.number} className="relative">
              ...
              <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] h-full flex flex-col">
                <span className="text-3xl font-bold text-emerald-500/20">{step.number}</span>
    ...
    <section id="contato" className="py-24 bg-[#060E0A]">
      <div className="max-w-2xl mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Leve o courtida para seu clube</h2>
          <p className="text-gray-400 text-lg">Deixe seu contato e nossa equipe entra em contato para agendar uma demonstração gratuita.</p>
        </div>
        <ContactForm />
      </div>
    </section>
