...
export default function ContactForm() {
  ...
  if (success) {
    return (
      <div className="text-center py-12 px-6 rounded-2xl" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-default)" }}>
        ...
        <h3 className="text-xl font-semibold mb-2" style={{ color: "var(--text-primary)" }}>Mensagem enviada!</h3>
  ...
  return (
    <div className="rounded-2xl p-8" style={{ backgroundColor: "var(--bg-card)", border: "1px solid var(--border-default)" }}>
      <div className="space-y-4">
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 rounded-xl text-sm placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all"
              style={inputStyle}
            />
          </div>
          <div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl text-sm placeholder:opacity-40 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 transition-all resize-none"
            style={inputStyle}
          />
        </div>
