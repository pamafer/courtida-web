...
const timeline = [
  { year: "2024", title: "Nasce a Preddita", description: "Fundada em Santa Catarina com a missão de levar automação inteligente para mercados tradicionais, entre os quais esportes de quadra." },
  { year: "2025", title: "Pesquisa e desenvolvimento", description: "Início do projeto courtida. Meses de pesquisa com clubes, jogadores e gestores para entender as dores reais do mercado." },
  { year: "2025", title: "Clube-laboratório", description: "Parceria com o primeiro clube para testes reais. Instalação de câmeras Full HD, terminal de reconhecimento facial e infraestrutura de streaming." },
  { year: "2026", title: "Lançamento do courtida", description: "Plataforma completa: gravação inteligente, streaming ao vivo e reconhecimento facial integrados em uma única solução para clubes." },
];
            ...
            {timeline.map((item, i) => (
              <div key={i} className="flex gap-6">
                <div className="flex flex-col items-center">
                  ...
                  {i < timeline.length - 1 && <div className="w-px h-full bg-white/5 my-2" />}
                </div>
                <div className="pb-10">
