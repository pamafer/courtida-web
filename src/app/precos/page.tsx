...
const plans = [
  {
    ...
    price: "199", period: "/mês por quadra", highlight: false,
    features: ["Plataforma courtida completa","Gravação Full HD + clips + streaming","Gestor de quadras","Torneios e rankings (2 formatos)","Revenue share: 50% para o clube","Suporte por email"],
    notIncluded: ["Hardware por conta do clube","Instalação por conta do clube","API dedicada"],
    cta: "Começar agora", fidelity: "Fidelidade mínima: 12 meses",
  },
  {
    name: "Pro",
    description: "O plano mais popular. Hardware incluso, instalação gratuita e maior revenue share.",
    price: "399", period: "/mês por quadra", highlight: true,
    features: ["Tudo do Starter, mais:","Hardware incluso em comodato","Instalação completa gratuita","Torneios e rankings (4 formatos)","Revenue share: 60% para o clube","Suporte prioritário"],
    notIncluded: ["API dedicada"],
    cta: "Escolher Pro", fidelity: "Fidelidade mínima: 24 meses",
  },
  {
    name: "Enterprise",
    description: "Para redes de clubes e operações com múltiplas quadras. Tudo personalizado.",
    price: "Sob consulta", period: "", highlight: false,
    features: ["Tudo do Pro, mais:","Revenue share: 70% para o clube","Desconto por volume (5+ quadras)","API dedicada","Branding personalizado","Torneios personalizados","Gerente de conta dedicado","Fidelidade negociável"],
    notIncluded: [],
    cta: "Falar com vendas", fidelity: "Fidelidade negociável",
  },
];
...
const faqs = [
  { question: "A instalação está inclusa no preço?", answer: "No plano Pro e Enterprise, sim. A instalação completa é gratuita. No plano Starter, a instalação e o hardware ficam por conta do clube." },
  { question: "O que é revenue share?", answer: "Revenue share é a porcentagem da receita gerada pelos jogadores (clips, pacotes, streaming) que o clube recebe. Quanto maior o plano, maior a fatia do clube: 50% no Starter, 60% no Pro, 70% no Enterprise." },
  { question: "Quanto o clube pode ganhar por quadra?", answer: "No cenário base com plano Pro (15 jogadores com pacote mensal, 100 clips avulsos e 20h de streaming/mês), o clube recebe aproximadamente R$ 509/mês em revenue share por quadra — além de oferecer uma experiência diferenciada aos jogadores." },
  { question: "Preciso comprar equipamentos?", answer: "No plano Pro e Enterprise, não. O hardware (câmeras Full HD e terminal de reconhecimento facial) está incluso em regime de comodato. No plano Starter, o clube adquire os equipamentos (a partir de R$ 2.299 por quadra)." },
  { question: "Tem fidelidade ou multa de cancelamento?", answer: "Starter: 12 meses. Pro: 24 meses (hardware em comodato). Enterprise: negociável. Após o período mínimo, cancelamento com 30 dias de aviso prévio." },
  { question: "O streaming gasta internet do clube?", answer: "Sim. Recomendamos no mínimo 20 Mbps de upload por quadra com streaming ativo. Podemos ajudar a avaliar sua infraestrutura antes da instalação." },
];
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="rounded-xl border border-white/5 bg-white/[0.02] overflow-hidden">
            <div className="grid grid-cols-3 px-5 py-3 border-b border-white/5 text-xs text-gray-500 font-medium uppercase tracking-wide">
              <span>Serviço</span><span>Preço</span><span className="text-right">Margem</span>
            </div>
